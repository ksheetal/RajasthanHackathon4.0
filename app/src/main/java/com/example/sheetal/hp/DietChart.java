...
public class DietChart extends AppCompatActivity {
    ...
    private DietSLideAdapter sliderAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sliderAdapter = new DietSLideAdapter(this);
...
//        updateView((String)Paper.book().read("language"));
        ...
        mNextBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (mCurrentPage == 3) {
                    ...
                    Intent intent = new Intent(DietChart.this, MainHomeActivity.class);   // sending to the Login Activity
    ...
    private void sendtoHome() {
        Intent mainIntent = new Intent(DietChart.this, HomeScreenActivity.class);
